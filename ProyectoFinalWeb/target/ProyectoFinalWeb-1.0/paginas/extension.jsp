...
<title>GameTopStore</title>
  <!-- Compiled and minified CSS -->
	...
	background-image: url(../img/fondos/fond9.jpg);
	text-align: justify;
...
<datalist id="listafechas">
  ...
  <option value="2015-05-26">
         ...
         <button type="submit" class="btn btn-xl">Mas tiempo</button>      
    </form>
...
<!-- Fin formulario -->
        ...
        <%
            ...
            if(clienteSolicitud!=null && juegoSolicitud!=null){
                ...
                String grabados = renta.extiendeFechaEntrega(numeroSolicitud, clienteSolicitud, juegoSolicitud);
